...
npm install -D typescript @types/bcrypt @types/cors @types/dotenv @types/express @types/inquirer @types/jsonwebtoken @types/mongoose @types/morgan @types/supertest @types/swagger-jsdoc @types/swagger-ui-express inquirer vitest supertest swagger-jsdoc swagger-ui-express @typescript-eslint/eslint-plugin @typescript-eslint/parser eslint eslint-config-standard-with-typescript
